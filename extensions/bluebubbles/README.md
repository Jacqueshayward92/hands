...
This directory contains the **BlueBubbles external channel plugin** for Hands.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `hands/plugin-sdk` helpers.
