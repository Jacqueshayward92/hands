...
export function listBlueBubblesAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: HandsConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: HandsConfig): ResolvedBlueBubblesAccount[] {
