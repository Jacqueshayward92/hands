...
import type { ReplyPayload, HandsConfig } from "hands/plugin-sdk";
import { createReplyPrefixOptions } from "hands/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as HandsConfig;
