...
Nostr DM channel plugin for Hands using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Hands. It enables your bot to:
...
# Configure hands to use local relay
