...
- Version alignment with core Hands release numbers.
...
- First public release of the @hands/voice-call plugin.
...
- CLI: `hands voicecall` commands (call/start/continue/speak/end/status/tail/expose).
