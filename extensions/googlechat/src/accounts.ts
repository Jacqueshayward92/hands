...
export function listGoogleChatAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: HandsConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: HandsConfig): ResolvedGoogleChatAccount[] {
