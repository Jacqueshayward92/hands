...
export function listZalouserAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: HandsConfig): string {
...
function mergeZalouserAccountConfig(cfg: HandsConfig, accountId: string): ZalouserAccountConfig {
