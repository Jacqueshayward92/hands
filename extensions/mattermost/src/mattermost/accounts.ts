...
export function listMattermostAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: HandsConfig): string {
...
export function listEnabledMattermostAccounts(cfg: HandsConfig): ResolvedMattermostAccount[] {
