import type { ChannelOnboardingAdapter, HandsConfig, WizardPrompter } from "hands/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.hands.ai/channels/mattermost",
    ].join("\n"),
