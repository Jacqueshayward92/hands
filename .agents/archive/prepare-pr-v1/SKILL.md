...
- `fix: <summary> (hands#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (hands#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "hands#$pr_number" || { echo "ERROR: commit subject missing hands#$pr_number"; exit 1; }
