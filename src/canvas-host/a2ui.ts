...
export const A2UI_PATH = "/__hands__/a2ui";

export const CANVAS_HOST_PATH = "/__hands__/canvas";

export const CANVAS_WS_PATH = "/__hands__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.handsCanvasA2UIAction.postMessage(...)
  // - Android: window.handsCanvasA2UIAction.postMessage(...)
  const handlerNames = ["handsCanvasA2UIAction"];
  ...
  globalThis.Hands = globalThis.Hands ?? {};
  globalThis.Hands.postMessage = postToNode;
  globalThis.Hands.sendUserAction = sendUserAction;
  globalThis.handsPostMessage = postToNode;
  globalThis.handsSendUserAction = sendUserAction;
