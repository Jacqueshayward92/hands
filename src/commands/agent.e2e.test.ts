...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "hands-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<HandsConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<HandsConfig["telegram"]>>,
