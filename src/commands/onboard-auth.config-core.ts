...
export function applyOpenrouterProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: HandsConfig): HandsConfig {
...
export function applyMoonshotProviderConfig(cfg: HandsConfig): HandsConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: HandsConfig): HandsConfig {
...
export function applyMoonshotConfig(cfg: HandsConfig): HandsConfig {
...
export function applyMoonshotConfigCn(cfg: HandsConfig): HandsConfig {
...
export function applyKimiCodeProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: HandsConfig): HandsConfig {
...
export function applySyntheticProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: HandsConfig): HandsConfig {
...
export function applyXiaomiProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: HandsConfig): HandsConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: HandsConfig): HandsConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: HandsConfig): HandsConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: HandsConfig): HandsConfig {
...
export function applyXaiProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: HandsConfig): HandsConfig {
...
export function applyQianfanProviderConfig(cfg: HandsConfig): HandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: HandsConfig): HandsConfig {
