...
function resolveDefaultAccountId(cfg: HandsConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: HandsConfig): boolean {
...
export function summarizeBindings(cfg: HandsConfig, bindings: AgentBinding[]): string[] {
