...
const ensureHandsModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveHandsAgentDir = vi.fn().mockReturnValue("/tmp/hands-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/hands-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureHandsModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveHandsAgentDir,
}));
