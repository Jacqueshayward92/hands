...
type PromptDefaultModelResult = { model?: string; config?: HandsConfig };
...
function resolveConfiguredModelRaw(cfg: HandsConfig): string {
...
function resolveConfiguredModelKeys(cfg: HandsConfig): string[] {
...
export function applyPrimaryModel(cfg: HandsConfig, model: string): HandsConfig {
...
export function applyModelAllowlist(cfg: HandsConfig, models: string[]): HandsConfig {
  const defaults = cfg.agents?.defaults;
