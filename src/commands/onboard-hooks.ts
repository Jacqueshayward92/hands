...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.hands.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("hands hooks list")}`,
      `  ${formatCliCommand("hands hooks enable <name>")}`,
      `  ${formatCliCommand("hands hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
