...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.HANDS_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: HandsConfig): string {
...
function mergeTelegramAccountConfig(cfg: HandsConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: HandsConfig): ResolvedTelegramAccount[] {
