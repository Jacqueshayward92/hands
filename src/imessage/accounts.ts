...
export function listIMessageAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: HandsConfig): string {
...
function mergeIMessageAccountConfig(cfg: HandsConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: HandsConfig): ResolvedIMessageAccount[] {
