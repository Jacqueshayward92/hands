...
const SANDBOX_EXAMPLES = {
  main: [
    ["hands sandbox list", "List all sandbox containers."],
    ["hands sandbox list --browser", "List only browser containers."],
    ["hands sandbox recreate --all", "Recreate all containers."],
    ["hands sandbox recreate --session main", "Recreate a specific session."],
    ["hands sandbox recreate --agent mybot", "Recreate agent containers."],
    ["hands sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["hands sandbox list", "List all sandbox containers."],
    ["hands sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["hands sandbox recreate --all", "Recreate all containers."],
    ["hands sandbox recreate --session main", "Recreate a specific session."],
    ["hands sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["hands sandbox recreate --browser --all", "Recreate only browser containers."],
    ["hands sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["hands sandbox explain", "Show effective sandbox config."],
    ["hands sandbox explain --session agent:main:main", "Explain a specific session."],
    ["hands sandbox explain --agent work", "Explain an agent sandbox."],
    ["hands sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.hands.ai/cli/sandbox")}\n`,
    )
    .action(() => {
