...
function resolveWatchPaths(workspaceDir: string, config?: HandsConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: HandsConfig }) {
