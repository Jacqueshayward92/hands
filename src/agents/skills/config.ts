...
import type { HandsConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: HandsConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: HandsConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["hands-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(entry.skill.source);
}

export function resolveBundledAllowlist(config?: HandsConfig): string[] | undefined {
