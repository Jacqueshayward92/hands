...
export const DEFAULT_SANDBOX_IMAGE = "hands-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "hands-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "hands-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "hands-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "hands-sbx-browser-";
