...
function resolveAvatarSource(cfg: HandsConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: HandsConfig, agentId: string): AgentAvatarResolution {
