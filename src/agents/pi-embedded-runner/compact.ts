...
import { resolveHandsDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  const agentDir = params.agentDir ?? resolveHandsAgentDir();
  await ensureHandsModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createHandsCodingTools({
      exec: {
    ...
    const docsPath = await resolveHandsDocsPath({
      workspaceDir: effectiveWorkspace,
