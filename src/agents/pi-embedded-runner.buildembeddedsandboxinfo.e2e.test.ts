...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies HandsConfig;

const _ensureModels = (cfg: HandsConfig, agentDir: string) =>
  ensureHandsModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/hands-sandbox",
      agentWorkspaceDir: "/tmp/hands-workspace",
      ...
      browser: {
        ...
        containerName: "hands-sbx-browser-test",
      },
