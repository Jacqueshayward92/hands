...
export function listSlackAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: HandsConfig): string {
...
function mergeSlackAccountConfig(cfg: HandsConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: HandsConfig): ResolvedSlackAccount[] {
