...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof HandsConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: HandsConfig; env: NodeJS.ProcessEnv }): {
  cfg: HandsConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
