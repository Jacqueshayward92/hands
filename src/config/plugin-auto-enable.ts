...
function isTelegramConfigured(cfg: HandsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: HandsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: HandsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: HandsConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: HandsConfig): boolean {
...
function isIMessageConfigured(cfg: HandsConfig): boolean {
...
function isWhatsAppConfigured(cfg: HandsConfig): boolean {
...
function isGenericChannelConfigured(cfg: HandsConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: HandsConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: HandsConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: HandsConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: HandsConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: HandsConfig, pluginId: string): HandsConfig {
...
function registerPluginEntry(cfg: HandsConfig, pluginId: string): HandsConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
