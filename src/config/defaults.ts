...
function resolveAnthropicDefaultAuthMode(cfg: HandsConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: HandsConfig): HandsConfig {
...
export function applyTalkApiKey(config: HandsConfig): HandsConfig {
...
export function applyModelDefaults(cfg: HandsConfig): HandsConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: HandsConfig): HandsConfig {
...
export function applyLoggingDefaults(cfg: HandsConfig): HandsConfig {
...
export function applyContextPruningDefaults(cfg: HandsConfig): HandsConfig {
...
export function applyCompactionDefaults(cfg: HandsConfig): HandsConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
