...
export function listSignalAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: HandsConfig): string {
...
function mergeSignalAccountConfig(cfg: HandsConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: HandsConfig): ResolvedSignalAccount[] {
