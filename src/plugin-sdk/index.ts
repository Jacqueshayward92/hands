...
export type { HandsConfig } from "../config/config.js";
/** @deprecated Use HandsConfig instead */
export type { HandsConfig as ClawdbotConfig } from "../config/config.js";
