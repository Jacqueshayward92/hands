...
import type { HandsPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverHandsPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, HandsPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["HANDS_PLUGIN_CATALOG_PATHS", "HANDS_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<HandsPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: HandsPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverHandsPlugins({ workspaceDir: options.workspaceDir });
