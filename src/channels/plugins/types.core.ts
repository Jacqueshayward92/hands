...
export type ChannelAgentToolFactory = (params: { cfg?: HandsConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: HandsConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: HandsConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: HandsConfig }) => boolean;
  supportsCards?: (params: { cfg: HandsConfig }) => boolean;
