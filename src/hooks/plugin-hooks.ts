...
import type { HandsPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: HandsPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: HandsPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
