...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: HandsConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: HandsConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: HandsConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: HandsConfig): void {
