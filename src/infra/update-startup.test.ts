...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "hands-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveHandsPackageRoot } = await import("./hands-root.js");
    ...
    vi.mocked(resolveHandsPackageRoot).mockResolvedValue("/opt/hands");
