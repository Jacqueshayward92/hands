...
function listConfiguredAccountIds(cfg: HandsConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: HandsConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: HandsConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: HandsConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: HandsConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: HandsConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: HandsConfig): ResolvedWhatsAppAccount[] {
