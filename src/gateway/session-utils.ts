...
import { type HandsConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: HandsConfig): string[] {
...
export function listAgentsForGateway(cfg: HandsConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: HandsConfig): string {
...
function resolveSessionStoreAgentId(cfg: HandsConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: HandsConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: HandsConfig): GatewaySessionsDefaults {
