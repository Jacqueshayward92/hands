...
import type { HandsConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: HandsConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: HandsConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: HandsConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: HandsConfig) => void;
  log: {
