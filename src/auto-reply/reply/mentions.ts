...
function resolveMentionPatterns(cfg: HandsConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: HandsConfig | undefined, agentId?: string): RegExp[] {
