...
export function listBindings(cfg: HandsConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: HandsConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: HandsConfig) {
