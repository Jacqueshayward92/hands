...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.HANDS_STATE_DIR;
  const configPath = env.HANDS_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    HANDS_PROFILE: profile,
    HANDS_STATE_DIR: stateDir,
    HANDS_CONFIG_PATH: configPath,
    HANDS_GATEWAY_PORT: String(port),
    HANDS_GATEWAY_TOKEN: token,
    HANDS_LAUNCHD_LABEL: resolvedLaunchdLabel,
    HANDS_SYSTEMD_UNIT: systemdUnit,
    HANDS_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    HANDS_SERVICE_KIND: GATEWAY_SERVICE_KIND,
