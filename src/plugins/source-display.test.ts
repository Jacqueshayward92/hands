...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/hands/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/hands/extensions",
        global: "/Users/x/.hands/extensions",
        workspace: "/Users/x/ws/.hands/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.hands/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/hands/extensions",
        global: "/Users/x/.hands/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.hands/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/hands/extensions",
        global: "/Users/x/.hands/extensions",
