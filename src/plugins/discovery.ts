...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @hands/voice-call -> voice-call).
...
export function discoverHandsPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".hands", "extensions")];
