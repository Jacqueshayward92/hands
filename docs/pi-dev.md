...
This guide summarizes a sane workflow for working on the pi integration in Hands.
...
- Trigger the agent directly:
  - `pnpm hands agent --message "Hello" --thinking low`
...
State lives under the Hands state directory. Default is `~/.hands`. If `HANDS_STATE_DIR` is set, use that directory instead.

To reset everything:

- `hands.json` for config
...
- [https://docs.hands.ai/testing](https://docs.hands.ai/testing)
- [https://docs.hands.ai/start/getting-started](https://docs.hands.ai/start/getting-started)
