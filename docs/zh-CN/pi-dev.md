...
本指南总结了在 Hands 中开发 Pi 集成的合理工作流程。
...
状态存储在 Hands 状态目录下。默认为 `~/.hands`。如果设置了 `HANDS_STATE_DIR`，则使用该目录。
...
- https://docs.hands.ai/testing
- https://docs.hands.ai/start/getting-started
