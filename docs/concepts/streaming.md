...
Hands has two separate “streaming” layers:
...
When block streaming is enabled, Hands can **merge consecutive block chunks**
...
When draft streaming is active, Hands disables block streaming for that reply to avoid double-streaming.
