...
Hands treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.hands/settings/voicewake.json`

Shape:

```json
{ "triggers": ["hands", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
