---
summary: "Overview of Hands onboarding options and flows"
read_when:
...
Hands supports multiple onboarding paths depending on where the Gateway runs
...
- [`hands onboard` command](/cli/onboard)

## macOS app onboarding

Use the Hands app when you want a fully guided setup on macOS. Docs:
