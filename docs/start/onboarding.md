---
summary: "First-run onboarding flow for Hands (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Hands">
...
<Step title="CLI">
  ...
  The app can install the global `hands` CLI via npm/pnpm so terminal
