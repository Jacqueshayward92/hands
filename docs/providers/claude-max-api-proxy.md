...
You can point Hands at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Hands
...
- [Anthropic provider](/providers/anthropic) - Native Hands integration with Claude setup-token or API keys
