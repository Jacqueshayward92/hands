---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Hands"
read_when:
  - You want Xiaomi MiMo models in Hands
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Hands uses
