---
summary: "Use Synthetic's Anthropic-compatible API in Hands"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Hands registers it as the
...
Note: Hands's Anthropic client appends `/v1` to the base URL, so use
