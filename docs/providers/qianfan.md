---
summary: "Use Qianfan's unified API to access many models in Hands"
read_when:
...
3. Hands installed on your system
...
4. Copy the API key for use with Hands

## CLI setup

```bash
hands onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Hands Configuration](/gateway/configuration)
