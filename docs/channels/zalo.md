...
- Install via CLI: `hands plugins install @hands/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `hands plugins install ./extensions/zalo`
   - From npm (if published): `hands plugins install @hands/zalo`
...
- Approve via:
  - `hands pairing list zalo`
  - `hands pairing approve zalo <CODE>`
...
- Example: `hands message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `hands channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `hands logs --follow`
