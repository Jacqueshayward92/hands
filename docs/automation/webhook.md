...
read_when:
  ...
  - Wiring external systems into Hands
title: "Webhooks"
---
...
- `hands webhooks gmail setup` writes `hooks.gmail` config for `hands webhooks gmail run`.
