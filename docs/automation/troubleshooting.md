...
hands system heartbeat last
hands logs --follow
hands config get agents.defaults.heartbeat
hands channels status --probe
```
...
```bash
hands config get agents.defaults.heartbeat.activeHours
hands config get agents.defaults.heartbeat.activeHours.timezone
hands config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
hands cron list
hands logs --follow
```
