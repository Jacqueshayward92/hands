...
read_when:
  - You are building a Hands plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (hands.plugin.json)

Every plugin **must** ship a `hands.plugin.json` file in the **plugin root**.
Hands uses this manifest to validate configuration **without executing plugin
