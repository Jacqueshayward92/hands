...
- Same path: run the app from a fixed location (for Hands, `dist/Hands.app`).
...
Workaround: move files into the Hands workspace (`~/.hands/workspace`) if you want to avoid per-folder grants.
