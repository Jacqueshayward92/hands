## Hands Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_hands-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm hands gateway --port 18789 --verbose
```
